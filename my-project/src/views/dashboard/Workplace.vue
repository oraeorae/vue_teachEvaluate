  ...
  <page-header-wrapper>
    <template v-slot:content>
      <div class="page-header-content">
        <div class="avatar">
          <a-avatar size="large" :src="avatar_user" />
        </div>
        <div class="content">
          ...
          <a-card :loading="loading" title="最新公告" :bordered="false">
            <a-list>
              <a-list-item :key="index" v-for="(item, index) in activities">
                <a-list-item-meta>
                  <a-avatar slot="avatar" size="small" :src="avatar_manage" />
                  <div slot="title">
        ...
        <a-col
          ...
          >
            <div class="members" style="min-height: 150px;width: 500px">
              <a>
                <a-avatar size="large" :src="avatar_introduce" />
...
export default {
  ...
  computed: {
    ...
    currentUser () {
      return {
        name: '陈泽涵',
        avatar: 'https://iconfont.alicdn.com/p/illus/preview_image/AzlcRA9UfOLb/c8a8c66c-2e4a-4d63-bae3-27508d792341.png'
      }
    },
    userInfo () {
