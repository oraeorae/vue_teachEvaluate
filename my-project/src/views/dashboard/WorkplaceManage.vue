    ...
    <div>
      <a-row :gutter="24">
        <a-col :xl="16" :lg="24" :md="24" :sm="24" :xs="24">
          ...
          <!-- 提交占比 -->
          <a-card class="antd-pro-pages-dashboard-analysis-salesCard" :loading="loading" :bordered="false" title="数据" :style="{ height: '100%' }">
            <h4>本轮提交数量占比</h4>
            <div>
              <!-- style="width: calc(100% - 240px);" -->
              <div>
                <v-chart :force-fit="true" :height="405" :data="pieData" :scale="scale">

                  <v-tooltip :showTitle="false" dataKey="score" />
                  <v-axis />
                  <!-- position="right" :offsetX="-140" -->
                  <v-legend dataKey="item"/>
                  <!-- 注意下面score表示的是数据的值 -->
                  <v-pie position="score" color="item" :vStyle="pieStyle" />
